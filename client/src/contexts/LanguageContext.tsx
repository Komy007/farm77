...
export const translations = {
  ...
  totalAreaValue: { ko: '77.0637 헥타르', en: '77.0637 Hectares', fr: '77.0637 Hectares' },
  fromPhnomPenh: { ko: '프놈펜에서', en: 'From Phnom Penh', fr: 'De Phnom Penh' },
  distanceValue: { ko: '86km 거리', en: '86km distance', fr: '86km de distance' },
  duration: { ko: '소요시간', en: 'Duration', fr: 'Durée' },
  durationValue: { ko: '1시간 47분', en: '1 hour 47 minutes', fr: '1h 47min' },
